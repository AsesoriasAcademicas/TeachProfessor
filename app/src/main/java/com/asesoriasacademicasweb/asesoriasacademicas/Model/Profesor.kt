...
class Profesor(_id: Int = 0, _nombre: String = "", _email: String = "", _telefono: String = "", _direccion: String = "", _contrasenia: String= "", _tipoPersona: String = "Profesor", _clases : ArrayList<Clase>): IProfesor, IPersona {
    ...
    constructor(_email: String, _contrasenia: String): this(0, "", _email, "", "", _contrasenia, "Profesor", ArrayList()){
        this.email = _email
        this.contrasenia = _contrasenia
    }

    constructor(_nombre: String, _email: String, _contrasenia: String): this(0, _nombre, _email, "", "", _contrasenia,"Profesor", ArrayList()){
        this.nombre = _nombre
        this.email = _email
        this.contrasenia = _contrasenia
    }
    ...
    override fun registroValido(context: Context, repetContrasenia: String, booleanCheck: Boolean): Int {
        val obj = Modelo()
