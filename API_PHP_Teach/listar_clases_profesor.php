...
$sql_query = "SELECT id_clase,fecha,hora,duracion,materia,tema,inquietudes,estado FROM CLASE INNER JOIN TUTORIA INNER JOIN PERSONA INNER JOIN PROFESOR WHERE TUTORIA.id_tutoria = CLASE.id_tutoria AND PERSONA.id_persona = PROFESOR.id_persona AND CLASE.id_profesor = PROFESOR.id_profesor AND email = '$email'";
